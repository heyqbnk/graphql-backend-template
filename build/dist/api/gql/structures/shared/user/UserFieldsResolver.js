...
let UserFieldsResolver = class UserFieldsResolver {
    posts(user) {
        return this.postsController.getUserPosts(user.id).map(p => new structures_1.Post(p));
    }
};
__decorate([
    typedi_1.Inject(() => controllers_1.PostsController),
    __metadata("design:type", controllers_1.PostsController)
], UserFieldsResolver.prototype, "postsController", void 0);
__decorate([
    type_graphql_1.FieldResolver(),
    __param(0, type_graphql_1.Root()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [structures_1.User]),
    __metadata("design:returntype", void 0)
], UserFieldsResolver.prototype, "posts", null);
UserFieldsResolver = __decorate([
    type_graphql_1.Resolver(() => structures_1.User)
], UserFieldsResolver);
exports.UserFieldsResolver = UserFieldsResolver;

//# sourceMappingURL=UserFieldsResolver.js.map
